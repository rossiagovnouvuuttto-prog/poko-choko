...
| случайное аниме | случайное аниме через Jikan API |
| посоветуй аниме романтика | топ-10 романтики на MAL, одно случайное |
| посоветуй аниме экшен | то же, жанр экшен (есть ужасы, фэнтези и т.п.) |
| эдит наруто | открывает первый обычный YouTube-ролик c эдитом/AMV |
| найди эдит | то же, но название берётся случайно через Jikan |
...
│   ├── window_manager.py        # Окна + браузер + поиск YouTube-видео
│   ├── anime.py                 # Jikan API: случайное аниме, подбор по жанру
